...
export function CitationSourcePanel({
  ...
  return (
    <aside className="flex h-full min-h-0 flex-col border-l border-zinc-800 bg-zinc-950/92">
      <div className="border-b border-zinc-800 p-4">
        ...
        <div
          ...
          className="mt-4 grid grid-cols-3 rounded-lg border border-zinc-800 bg-zinc-900 p-1"
          role="tablist"
        >
          {tabs.map((tab) => (
            <button
              ...
              className={cn(
                "rounded-md px-2 py-1.5 text-xs font-medium transition focus:outline-none focus:ring-2 focus:ring-cyan-300/60",
                activeTab === tab.id
        ...
        {activeTab !== "activity" && (
          <label className="mt-4 flex items-center gap-2 rounded-lg border border-zinc-800 bg-zinc-900 px-3 py-2 text-sm text-zinc-400 focus-within:border-cyan-300/70">
